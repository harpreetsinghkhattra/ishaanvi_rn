import { PanResponder, Platform, ScrollView, StyleSheet, View, Text, ViewPagerAndroid } from 'react-native'
 ...
 * customizeable for ios using scroll view and for android react-native default ViewPager
 */
export default class ViewPager extends Component {
    static propTypes = { ...ViewPagerAndroid.propTypes }

    /**
     * defalut properties for this class
     */
    static defaultProps = {
        initialPage: 0,
    ...
    _onScrollOnIOS(e) {
        ...
        console.log('=======', offset, x, '/', this.state.width, position);
    ...
    /**
     * set page on click and on scroll horizontally
