        ...
        return (
            <WRow dial={5} style={[stretch, container]}>
                <WView flex dial={4} style={[leftContainer]}>
                    <WText fontFamily={'Muli-Bold'} fontSize={16} lines={2}>Jungle Yoga Retreat and Hiking</WText> 
                    <WRow dial={4}>
                ...
                <WView dial={6} style={rightContainer}>
                    <WText right color={Palette.line_color}>from <WText right color={Palette.line_color} style={[{ textDecorationLine: 'line-through' }]}>₹169</WText></WText>
                    <WText center fontSize={16} fontFamily={"Muli-Bold"}>₹160</WText>
                    <WText center style={[{ backgroundColor: Palette.theme_color }]} color={Palette.white} padding={[5, 10]}>Save 5%</WText>
                </WView>
            </WRow>
        );
    }
